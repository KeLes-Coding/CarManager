        ...
        tvShangye.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (page > 1) {
                    ...
                    Toast.makeText(UpdateActivity.this, "当前第一页", Toast.LENGTH_SHORT).show();
                }
        ...
        tvNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (page < totalPage) {
                    ...
                    Toast.makeText(UpdateActivity.this, "到达尾页", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //跳转页码
        btnTiaozhuan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (page > 0 && page <= totalPage) {
                    ...
                    Toast.makeText(UpdateActivity.this, "超过最大页数", Toast.LENGTH_SHORT).show();
    ...
    private void selectFenYe(String name,int page){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                adapter = new BaseAdapter() {
                    ...
                    public View getView(final int i, View view, ViewGroup viewGroup) {
                        view = View.inflate(UpdateActivity.this, R.layout.item_carlist2, null);
                        ...
                        final TextView delete = view.findViewById(R.id.item_carDelete);
                        ...
                        update.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                int id = car.getCars().get(i).getId();
                                String name= car.getCars().get(i).getCar_name();
                                String img= car.getCars().get(i).getCar_img();
                                String brand=car.getCars().get(i).getCar_brand();
                                String info=car.getCars().get(i).getCar_info();
                                // String lianjie=car.getCars().get(i).getCar_download();
                                Intent intent=new Intent(UpdateActivity.this,UpdateCarActivity.class);
                        ...
                        Glide.with(UpdateActivity.this).load(car.getCars().get(i).getCar_img()).into(imageView);
            ...
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(UpdateActivity.this, "网络出错", Toast.LENGTH_SHORT).show();
            }
        });
